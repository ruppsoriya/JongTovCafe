const localCafes = [
  {
    ...
    description:
      "Specialty coffee roastery in BKK1 with strong WiFi and a calm study vibe.",
    ...
    location: {
      ...
      googleMapsUrl:
        "https://www.google.com/maps/search/BROWN+Roastery+Phnom+Penh",
    },
    popularity: 90,
    isOpen: true,
    openingHours: {
  ...
  },
  {
    ...
    description:
      "Bright specialty cafe with reliable Internet and an easy remote-work setup.",
    ...
    location: {
      ...
      googleMapsUrl:
        "https://www.google.com/maps/search/Feel+Good+Coffee+Phnom+Penh",
    },
    popularity: 94,
    isOpen: true,
    openingHours: {
  ...
  },
  {
    ...
    description:
      "Creative cafe in Toul Kork with a comfortable workspace feel.",
    ...
    location: {
      ...
      googleMapsUrl:
        "https://www.google.com/maps/search/Java+Creative+Cafe+Toul+Kork",
    },
    popularity: 78,
    isOpen: true,
    openingHours: {
  ...
  },
  {
    ...
    name: "Backyard Cafe",
    description:
      "Healthy cafe with outdoor seating and a relaxed neighborhood atmosphere.",
    ...
    location: {
      ...
      googleMapsUrl:
        "https://www.google.com/maps/search/Backyard+Cafe+Phnom+Penh",
    },
    popularity: 84,
    isOpen: true,
    openingHours: {
  ...
  },
  {
    ...
    name: "Living Room",
    description:
      "Comfortable and spacious cafe for long study sessions or casual meetings.",
    ...
    location: {
      address: "Phnom Penh",
      googleMapsUrl:
        "https://www.google.com/maps/search/Living+Room+Cafe+Phnom+Penh",
    },
    popularity: 76,
    isOpen: true,
    openingHours: {
  ...
  },
  {
    ...
    description:
      "Upscale cafe and lounge for work, conversation, and a slower coffee pace.",
    ...
    location: {
      address: "Phnom Penh",
      googleMapsUrl:
        "https://www.google.com/maps/search/Market+Cafe+Lounge+Phnom+Penh",
    },
    popularity: 81,
    isOpen: true,
    openingHours: {
